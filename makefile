...
local-out-zip-file := lewa_oppo_n1.zip

# the location for local-ota to save target-file
local-previous-target-dir := ~/workspace/ota_base/oppo_n1
...
# All apks from LEWA
local-lewa-removed-apps := Bluetooth LewaPond LewaGallery2 LewaCamera
...
local-pre-zip-misc: add-prebuilt-lewa-sqlite-library
	cp others/apns-conf.xml $(ZIP_DIR)/system/etc/
