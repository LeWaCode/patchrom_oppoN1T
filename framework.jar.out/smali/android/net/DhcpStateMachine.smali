...
.method private runDhcp(Landroid/net/DhcpStateMachine$DhcpAction;)Z
    ...
    .line 377
    const-string v5, "dhcp.wlan0.result"
    ...
    const-string v7, ", We set DHCP failed!"
    ...
    const-string v7, "dhcp.wlan0.result="
    ...
    invoke-virtual {v5, v11, v6, v7, v8}, Landroid/app/AlarmManager;->set(IJLandroid/app/PendingIntent;)V
    ...
    invoke-virtual {v5, v12, v6, v10, v0}, Lcom/android/internal/util/StateMachine;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v5, v12, v11, v10}, Lcom/android/internal/util/StateMachine;->obtainMessage(III)Landroid/os/Message;
