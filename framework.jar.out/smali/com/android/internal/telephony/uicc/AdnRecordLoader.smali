...
.method public buildEmailString(Ljava/lang/String;I)[B
    ...
    const-string v4, "Email String != null"

    invoke-static {v3, v4}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 488
    invoke-static {p1}, Lcom/android/internal/telephony/OppoGsmAlphabet;->stringToGsm8BitOrUCSPackedForADN(Ljava/lang/String;)[B
...
.method public buildNumber2String(Ljava/lang/String;)[B
    .locals 7
    .parameter "num"
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->NEW_METHOD:Landroid/annotation/OppoHook$OppoHookType;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/internal/telephony/uicc/AdnRecordLoader;->buildNumber2String(Ljava/lang/String;)[B
    ...
    invoke-virtual {v0, v2, v3}, Lcom/android/internal/telephony/uicc/AdnRecordLoader;->buildEmailString(Ljava/lang/String;I)[B
...
.method public updateANR(Lcom/android/internal/telephony/uicc/AdnRecord;IIILjava/lang/String;Landroid/os/Message;)V
    .locals 6
    .parameter "adn"
    .parameter "ef"
    .parameter "extensionEF"
    ...
    const-string/jumbo v2, "updateANR efid="
    ...
    iget-object v2, p1, Lcom/android/internal/telephony/uicc/AdnRecord;->number2:Ljava/lang/String;
    ...
    .line 547
    iget-object v0, p1, Lcom/android/internal/telephony/uicc/AdnRecord;->number2:Ljava/lang/String;

    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/uicc/AdnRecordLoader;->buildNumber2String(Ljava/lang/String;)[B
...
.method public updateEmail(Lcom/android/internal/telephony/uicc/AdnRecord;IIILjava/lang/String;Landroid/os/Message;)V
    .locals 6
    .parameter "adn"
    .parameter "ef"
    .parameter "extensionEF"
    ...
    const-string/jumbo v2, "updateEmail efid="
    ...
    .line 567
    iget-object v0, p1, Lcom/android/internal/telephony/uicc/AdnRecord;->emails:[Ljava/lang/String;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    invoke-virtual {p1}, Lcom/android/internal/telephony/uicc/AdnRecord;->getEmailLen()I

    move-result v1

    invoke-virtual {p0, v0, v1}, Lcom/android/internal/telephony/uicc/AdnRecordLoader;->buildEmailString(Ljava/lang/String;I)[B
