...
.field static final OPPO_EVENT_UPDATE_ANR_DONE:I = 0x3
...
.field static final OPPO_EVENT_UPDATE_EMAIL_DONE:I = 0x4
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->NEW_FIELD:Landroid/annotation/OppoHook$OppoHookType;
        note = "add email and anr number for cmcc and phonebook"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->OPPO:Landroid/annotation/OppoHook$OppoRomType;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 385
    .local v2, efid:I
    iget-object v0, p0, Lcom/android/internal/telephony/uicc/AdnRecordCache;->adnLikeWaiters:Landroid/util/SparseArray;
    ...
    .line 391
    :cond_0
    invoke-direct {p0, v9, v7}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->notifyWaiters(Ljava/util/ArrayList;Landroid/os/AsyncResult;)V
    ...
    .line 403
    iget v0, v1, Lcom/android/internal/telephony/uicc/AdnRecord;->emailefid:I

    if-lez v0, :cond_1

    iget v0, v1, Lcom/android/internal/telephony/uicc/AdnRecord;->iapefid:I
    ...
    invoke-direct {v0, v6}, Lcom/android/internal/telephony/uicc/AdnRecordLoader;-><init>(Lcom/android/internal/telephony/uicc/IccFileHandler;)V

    const/4 v6, 0x4

    invoke-virtual {p0, v6, v2, v4, v1}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object v6

    invoke-virtual/range {v0 .. v6}, Lcom/android/internal/telephony/uicc/AdnRecordLoader;->updateEmail(Lcom/android/internal/telephony/uicc/AdnRecord;IIILjava/lang/String;Landroid/os/Message;)V
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->invalidateCache()V
    ...
    invoke-static {v8, v5, v0}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
    ...
    const-string/jumbo v3, "update ANR record failed"
    ...
    const-string/jumbo v3, "update Email record failed"
    ...
    iget v0, v1, Lcom/android/internal/telephony/uicc/AdnRecord;->recordNumber:I

    if-gtz v0, :cond_4

    .line 448
    iput v4, v1, Lcom/android/internal/telephony/uicc/AdnRecord;->recordNumber:I
    ...
    iget-object v0, v1, Lcom/android/internal/telephony/uicc/AdnRecord;->emails:[Ljava/lang/String;

    if-eqz v0, :cond_5

    const/4 v0, 0x1

    iget-object v6, v1, Lcom/android/internal/telephony/uicc/AdnRecord;->emails:[Ljava/lang/String;
    ...
    .line 463
    iput-object v5, v1, Lcom/android/internal/telephony/uicc/AdnRecord;->emails:[Ljava/lang/String;
    ...
    const-string v6, "EVENT_UPDATE_ADN_DONE efid= "
    ...
    iget-object v6, v1, Lcom/android/internal/telephony/uicc/AdnRecord;->number2:Ljava/lang/String;
